...
*
* Do-file:      table-12.do
* Purpose:      Replicates Table 12: Balance test of 1890 parish occupational
...
*===============================================================================
* STEP 1: PREPARE DATA AT THE PARISH LEVEL FOR 1890 (UNBALANCED)
*===============================================================================
...
* --- Part B: Calculate 1890 occupational shares (Full Sample) ---
...
esttab V*, using "$output_dir/table-12.tex", replace booktabs noobs nonumbers ///
